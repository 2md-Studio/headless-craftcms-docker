# Headless Craft Starter

[Forked from NY Studio 107](https://github.com/nystudio107/craft)

This repo only contains the code to run craftcms.  All of the frontend stuff has been removed as we will be using Craft in headless mode with the frontend built with nextjs.

[Click here to get started](#setting-up-local-dev)
